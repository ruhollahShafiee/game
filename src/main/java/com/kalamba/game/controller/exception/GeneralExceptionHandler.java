package com.kalamba.game.controller.exception;

import com.kalamba.game.config.AppConfig;
import com.kalamba.game.controller.response.ErrorTemplate;
...
public class GeneralExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity handleNoSuchElementException(Exception exception, WebRequest request) {
        List<String> error = Arrays.asList(new String[]{exception.getMessage()});
        return getExceptionResponseEntity(exception, HttpStatus.BAD_REQUEST, request, error,appConfig.getServerThrowErrorDetails());
    }
