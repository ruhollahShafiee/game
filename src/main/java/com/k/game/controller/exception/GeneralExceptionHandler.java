package com.k.game.controller.exception;

import com.k.game.controller.response.ErrorTemplate;
import com.k.game.controller.response.ResponseTemplate;
import com.k.game.config.AppConfig;
...
public class GeneralExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity handleNoSuchElementException(Exception exception, WebRequest request) {
        List<String> error = Collections.singletonList(exception.getMessage());
